...
textures = {
    DIRT: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\dirt.png'),
    GRASS: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\grass.png'),
    WATER: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\water.png'),
    COAL: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\coal.png'),
    CLOUD: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\cloud.png'),
    BRICK: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\brick.png'),
    DIAMOND: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\diamond.png'),
    FIRE: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\fire.png'),
    GLASS: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\glass.png'),
    ROCK: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\rock.png'),
    SAND: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\sand.png'),
    STONE: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\stone.png'),
    WOOD: pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\wood.png')
}

player = pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\char.png')
playerPos = [0,0]
...
def which_bird(bird_count):
    if bird_count == 1:
        return 2, pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\bird2.png')
    elif bird_count == 2:
        return 3, pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\bird3.png')
    else:
        return 1, pygame.image.load('C:\\Users\\sjoer\\Pictures\\game images\\bird1.png')
